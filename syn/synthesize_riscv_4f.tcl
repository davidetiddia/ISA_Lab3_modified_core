...
elaborate RISC_V -arch pipeline -lib WORK > ./elaborate_4f.txt

link
#1.1723
create_clock -name MY_CLK -period 5.12 CLK
...
report_resources > resources_4f.txt
report_timing > timing_4f.txt
report_area > area_4f.txt
report_power > power_4f.txt

change_names -hierarchy -rules verilog

write -f verilog -hierarchy -output ../RISC_V_4f.v

write_sdf ../netlist/RISC_V_4f.sdf

write_sdc ../netlist/RISC_V_4f.sdc
